    ...
    const renderCurrentMenu = () => {
        switch (currentStep) {
            case MENU_STEPS.CINEMA:
                return <MenuSelectCinema snackTicketData={snackTicketData} updateSnackTicket={updateSnackTicket} onBack={goToPreviousStep} onNext={goToNextStep} getSnacks={getSnacks} />;
            ...
            case MENU_STEPS.INFO:
                return <MenuInfo onNext={goToNextStep} onBack={goToPreviousStep} snackTicketData={snackTicketData} updateSnackTicket={updateSnackTicket} />;
            ...
            case MENU_STEPS.TICKET_DISPLAY:
                return <MenuTicketDisplay snackTicketData={snackTicketData} ticket={ticket} loading={ticketLoading} />;
            default:
                return <MenuSelectCinema snackTicketData={snackTicketData} updateSnackTicket={updateSnackTicket} onBack={goToPreviousStep} onNext={goToNextStep} />;
        }
    };

    return (
        <div className="relative flex h-auto min-h-screen w-screen flex-col overflow-hidden overflow-y-hidden bg-slate-950">
            <Header />
