...
const ResetPwd = () => {
    ...
    return (
        <section className="relative bg-slate-950 overflow-x-hidden overflow-y-hidden w-screen min-h-screen no-scrollbar">
            ...
            "/>
            <div className="
                absolute lg:bottom-[200px] md:bottom-[190px] sm:bottom-[180px] bottom-[170px]
                lg:left-[200px] md:left-[150px] sm:left-[130px] left-[100px]
                lg:w-44 md:w-40 sm:w-38 w-35
                lg:h-44 md:h-40 sm:h-38 h-35
            ...
            <div className="absolute 
                lg:left-20 md:left-10 sm:left-8 left-5
                lg:top-25 md:top-20 sm:top-15 top-10
                flex items-center">
                <BackwardButton 
                    onClick={() => navigate(-1)} 
                    position="relative" 
