...
const Registration = () => {
    return (
        <section className="relative bg-slate-950 overflow-x-hidden w-screen min-h-screen no-scrollbar">
            <Header/>
            ...
            "/>
            <div className="
                absolute lg:-bottom-0 md:-bottom-0 sm:-bottom-0 -bottom-0 
                lg:-right-100 md:-right-[80px] sm:-right-[60px] -right-[40px]
