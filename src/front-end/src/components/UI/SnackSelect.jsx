...
const SnackSelect = ({ snack_type }) => {
    return (
        <div className="relative flex h-auto w-[calc((90vw/2)-20px)] flex-col items-center justify-between rounded-xl md:w-[calc((90vw/4)-20px)] lg:w-[calc((70vw/4)-20px)]">
            <img src={Combo1} alt="Snack Combo" className="z-5 h-auto w-1/3 rounded-t-xl object-cover pt-3" />
            <div className="relative w-full justify-start px-3 text-center font-['Unbounded'] text-[10px] font-semibold whitespace-normal text-white xl:text-[12px]">{snack_type}</div>
