...
const backwardButton = ({ onClick, position = 'absolute' }) => {
    ...
    return (
        <button onClick={onClick} className={`${positionClass} h-[45px] w-[45px] sm:h-[60px] sm:w-[60px] lg:h-[70px] lg:w-[70px] xl:h-[80px] xl:w-[80px] hover:cursor-pointer`} aria-label="BackwardButton">
