...
export const BackNaviButton = ({ onClick }) => (
    <button className="group relative flex aspect-square h-auto flex-row items-center justify-center px-3 transition-all duration-300 hover:cursor-pointer md:px-2.5" onClick={onClick}>
