...
const SearchButton = () => {
    ...
    return (
        <div className="z-50 flex h-[36px] w-auto -translate-y-1 items-center">
            ...
            <button
                onClick={handleClick}
                className="h-[25px] w-[12px] transition-transform duration-200 hover:scale-110 hover:cursor-pointer md:h-[30px] md:w-[15px] lg:h-[40px] lg:w-[25px] xl:h-[45px] xl:w-[30px]"
                aria-label="Search"
            >
