...
const backwardButton = ({ onClick, position = 'absolute' }) => {
    ...
    return (
        <button onClick={onClick} className={`${positionClass} h-[30px] w-[30px] sm:h-[40px] sm:w-[40px] lg:h-[50px] lg:w-[50px] xl:h-[60px] xl:w-[60px] hover:cursor-pointer`} aria-label="BackwardButton">
