            ...
            try {
                await html5QrCode.start(
                    ...
                    (decodedText, decodedResult) => {
                        ...
                        if (lastScannedCode.current === cleanedCode && currentTime - lastScanTime.current < scanCooldown) {
    ...
    return (
        <div className="relative h-full w-full overflow-hidden rounded-lg">
            ...
            <button
                ...
                className="absolute top-2 right-2 z-100 aspect-square h-auto rounded-full px-3 font-['Unbounded'] text-4xl font-bold text-white hover:bg-white/40"
            >
                ×
            </button>
            ...
            <div className="pointer-events-none absolute inset-0 z-10">
                ...
                <div className="absolute top-1/2 left-1/2 aspect-square h-[70%] w-[70%] -translate-x-1/2 -translate-y-1/2">
