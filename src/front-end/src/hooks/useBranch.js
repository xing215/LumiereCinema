...
export const useUpdateScreen = () => {
    ...
    const updateScreen = useCallback(
        async (branchId, screenId, screenData) => {
            setLoading(true);
            setError(null);
        ...
        try {
            ...
            if (response.schedules && Array.isArray(response.schedules)) {
                ...
                transformedSchedules = response.schedules.map((schedule) => ({
                    ...
                    availableSeatsCount: schedule.screen.size ? schedule.screen.size.rows * schedule.screen.size.columns - (schedule.ticketsSold || 0) : 0,
                }));
...
export const useGetScreenSeats = () => {
    ...
    const getScreenSeats = useCallback(
        async (branchId, screenId) => {
...
export const useBulkCreateSeats = () => {
    ...
    const bulkCreateSeats = useCallback(
        async (branchId, screenId, seatsData) => {
            setLoading(true);
            setError(null);
...
export const useUpdateSeat = () => {
    ...
    const updateSeat = useCallback(
        async (branchId, screenId, seatId, seatData) => {
            setLoading(true);
            setError(null);
