    ...
    return (
        <div className="relative flex w-screen items-center justify-center pt-3 md:pt-7">
            <div className="relative flex h-full w-full flex-row justify-center rounded-xl md:min-h-[470px] md:w-screen lg:h-auto lg:w-[calc(75vw)]">
                ...
                <div className="relative flex py-10 min-h-[400px] flex-col w-full items-center justify-center">
                    <ChooseCinemaButton
                    ...
                    <div className="absolute hidden bottom-0 h-auto w-auto flex-row items-center justify-end gap-2 px-4 pb-6 sm:px-8 md:flex md:px-10 lg:px-12">
            ...
            >
                ...
                <div className="relative flex-1 text-center font-['Unbounded'] text-[9px] font-semibold text-white">
                    Cinema: {snackTicketData.branch?.name || 'Select a cinema'}
                </div>
                <NextNaviButton text={"SNACKS"} onClick={handleNextClick} />
            </div>
            </div>
