...
const MovieCard = ({ movie, onSelect }) => {
  return (
    <div 
      className="md:h-[110px] min-h-auto w-[32%] flex flex-row relative rounded-xl overflow-hidden cursor-pointer" 
    ...
    >
      ...
      <div className="w-full flex-1 h-auto">
        <div className="w-full flex flex-col justify-between p-4 h-auto">
          <div className="pl-2 text-md font-bold h-auto font-['Unbounded'] line-clamp-2 text-white">
            {movie.title}
          </div>
