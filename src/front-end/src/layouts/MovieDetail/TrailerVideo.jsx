...
export const TrailerVideo = ({ videoYouTube }) => {
    ...
    if (videoError) return <div className="h-20 w-full lg:h-30" />;
    ...
    return (
        <div className="relative z-15 flex w-full items-center justify-center">
            ...
            <div className="pointer-events-none absolute left-0 h-full w-[5%] bg-gradient-to-r from-slate-950 to-transparent" />
            <div className="pointer-events-none absolute right-0 h-full w-[5%] bg-gradient-to-l from-slate-950 to-transparent" />
            <div className="pointer-events-none absolute -bottom-5 h-[50%] w-full bg-gradient-to-t from-slate-950 to-transparent blur-xs" />
        </div>
    );
};
