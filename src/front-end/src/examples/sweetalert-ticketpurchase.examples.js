...
const showConfirmationExamples = async () => {
    ...
    const result = await showConfirmation(
        'Leave Ticket Purchase?',
        'Are you sure you want to leave? Your selection will be lost.',
        'Yes, Leave',
        'Stay'
    );
    ...
    const clearResult = await showConfirmation(
        'Clear Selection?',
        'This will clear all your selected seats and snacks.',
        'Clear All',
        'Cancel'
    );
