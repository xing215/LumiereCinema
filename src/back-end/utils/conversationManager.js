...
class ConversationManager {
    ...
    shouldResetContext(currentContext, newIntent) {
        if (currentContext.lastIntent === 'find_schedules' && newIntent && !['find_schedules'].includes(newIntent)) {
            return true;
        }
        ...
        try {
            ...
            if (interactionData.lastInteractionType) {
                ...
                if (updatedInteractionContext.conversationalFlow.length > 20) {
                    updatedInteractionContext.conversationalFlow =
                        updatedInteractionContext.conversationalFlow.slice(-20);
                }
            }
